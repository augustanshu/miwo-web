...
abstract class BaseRepository implements BaseRepositoryInterface
{
	...
	*
	**/
	public function countItem($columns=['*'],$val)
	{
		$model=$this->model->where($columns,'=',$val)->count();
		$this->resetModel();
		return $model;
	}
	 /**
     * Find data by parent_id.
     *
     * 
     * @param array $columns
     *
     * @return mixed
     */
	public function findParent($columns=['*'])
	{
		$model=$this->model->where('parent_id',$columns);
		$this->resetModel();
		return $model;
	}
