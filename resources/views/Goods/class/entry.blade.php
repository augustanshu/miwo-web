    ...
    <div class="row">
        <div class='col-md-3 col-sm-4'>
            <div class='col-md-12 col-sm-12'>
                {!! Former::text('name')
                -> label(trans('goods.goodsclass.label.name'))
                -> placeholder(trans('goods.goodsclass.placeholder.name')) !!}
            </div>
            <div class='col-md-12 col-sm-12'>
                {!! Former::text('email')
                -> label(trans('goods.goodsclass.label.parent-id'))
                -> placeholder(trans('goods.goodsclass.placeholder.parent-id')) !!}
            </div>
            <div class='col-md-12 col-sm-12'>
                {!! Former::text('descroption')
                -> label(trans('goods.goodsclass.label.description'))
                -> placeholder(trans('goods.goodsclass.placeholder.description')) !!}
            </div>
        </div>
        <!--
        <div class='col-md-3 col-sm-4'>
